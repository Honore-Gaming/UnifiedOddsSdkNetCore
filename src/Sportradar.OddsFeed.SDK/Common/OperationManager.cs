...
namespace Sportradar.OddsFeed.SDK.Common
{
    ...
    public static class OperationManager
    {
        ...
        static OperationManager()
        {
            ...
            RabbitConnectionTimeout = (int)ConnectionFactory.DefaultConnectionTimeout.TotalSeconds;
            RabbitHeartbeat = (int)ConnectionFactory.DefaultHeartbeat.TotalSeconds;
